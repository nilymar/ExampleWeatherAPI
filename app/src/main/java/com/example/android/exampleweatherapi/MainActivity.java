...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Weather>> {
    ...
    private static final String SHARED_PREFERENCES = "weatherappshared"; // name for sharedPreferences location
    ...
    public Loader<List<Weather>> onCreateLoader(int id, Bundle args) {
        ...
        String queryCity = sharedPrefs.getString(getString(R.string.settings_city_key),
    ...
    public void onLoadFinished(Loader<List<Weather>> loader, List<Weather> weathers) {
        ...
        if (weathers != null && !weathers.isEmpty()) {
            ...
            String forecastTitle = getString(R.string.forecast_title) + weathers.get(0).getCity();
    ...
    // what happens when the user click on back
    @Override
